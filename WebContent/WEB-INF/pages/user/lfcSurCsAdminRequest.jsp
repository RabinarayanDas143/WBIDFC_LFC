...
<script type="text/javascript" src="static/js/hrms/lfcSurrenderDetails.js"></script><script type="text/javascript">
									...
									<div class="form-group Design-table">
										...
										<div id="person_allow">
											<table id="dependentTable" class="table table-striped">
												...
												<tbody id="SurCsAdminModalData"></tbody>
											</table>
										</div>
									</div>
								</div>
