...
@Entity
@Table(name = "refreshments_users")
public class Refreshments_Users {

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY, generator = "refreshments_usersSeq")
	@SequenceGenerator(name = "refreshments_usersSeq", sequenceName = "refreshments_usersSeq", allocationSize = 1, initialValue = 1)
	private int id;
