...
@Entity
@Table(name = "conveyance_users")
public class Conveyance_Users {

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY, generator = "conveyance_usersSeq")
	@SequenceGenerator(name = "conveyance_usersSeq", sequenceName = "conveyance_usersSeq", allocationSize = 1, initialValue = 1)
	private int id;
