...
@Entity
@Table(name = "foodbeverages_users")
public class FoodBeverages_Users {

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY, generator = "foodBeverages_usersSeq")
	@SequenceGenerator(name = "foodBeverages_usersSeq", sequenceName = "foodBeverages_usersSeq", allocationSize = 1, initialValue = 1)
	private int id;
