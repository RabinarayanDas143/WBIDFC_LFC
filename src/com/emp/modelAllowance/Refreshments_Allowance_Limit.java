...
@Entity
@Table(name = "refreshments_limit")
public class Refreshments_Allowance_Limit {

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY, generator = "refreshments_limitSeq")
	@SequenceGenerator(name = "refreshments_limitSeq", sequenceName = "refreshments_limitSeq", allocationSize = 1, initialValue = 1)
	private int id;
