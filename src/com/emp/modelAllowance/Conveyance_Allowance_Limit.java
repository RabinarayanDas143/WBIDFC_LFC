...
@Entity
@Table(name = "conveyance_limit")
public class Conveyance_Allowance_Limit {

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY, generator = "conveyance_limitSeq")
	@SequenceGenerator(name = "conveyance_limitSeq", sequenceName = "conveyance_limitSeq", allocationSize = 1, initialValue = 1)
	private int id;
