...
@Entity
@Table(name = "eye_checkup_limit")
public class Eye_Checkup_All_Limit {

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY, generator = "eye_checkup_limitSeq")
	@SequenceGenerator(name = "eye_checkup_limitSeq", sequenceName = "eye_checkup_limitSeq", allocationSize = 1, initialValue = 1)
	private int id;
