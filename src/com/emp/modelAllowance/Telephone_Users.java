...
@Entity
@Table(name = "telephone_users")
public class Telephone_Users {

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY, generator = "telephone_usersSeq")
	@SequenceGenerator(name = "telephone_usersSeq", sequenceName = "telephone_usersSeq", allocationSize = 1, initialValue = 1)
	private int id;
